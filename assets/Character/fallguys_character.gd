...
# ─────────────────────────────────────────
# This script controls the character's
# animations and which direction it faces.
# It is called every frame from the main
# character script (character_body_3d.gd)
# ─────────────────────────────────────────
